...
const carTypeListController = (_req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const cars = yield (0, fetchCars_1.default)();
    if (cars) {
        const types = getCarTypes(cars.data);
        const response = new responseGenerator_1.default(200, "Success", { types });
...
exports.default = carTypeListController;
